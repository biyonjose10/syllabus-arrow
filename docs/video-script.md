...
| 2b | Deck slide 2 | It's built for university and senior-school students taking a course with a written syllabus and a final exam, especially in subjects where topics build on each other: maths, physics, engineering and computer science. |
...
| 10b | Deck slide 8 | The impact is timing. A shaky foundation shows up in week three, while there's still time to fix it, not on the exam. A student gets a prerequisite-ordered plan in minutes instead of building one by hand, and the free plan is enough for a whole course. |
...
| 12 | Deck slide 10 | Next: class plans, where a teacher uploads once and a whole cohort practises; importing courses straight from Canvas and Moodle; and re-planning every morning around what you actually know. Syllabus Arrow. Try the demo course at syllabus-arrow dot vercel dot app. |
